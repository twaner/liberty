# Django settings for liberty project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'LibertyDatabaseTest',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '$x@-o-9r_=+lt)2@dg8h%-(dprk&bm-+3_0)gpjbvfoq$5rydi'
