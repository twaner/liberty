...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sales_Prospect.address'
        db.add_column(u'client_sales_prospect', 'address',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['common.Address']),
                      keep_default=False)

        # Adding field 'Sales_Prospect.contact_info'
        db.add_column(u'client_sales_prospect', 'contact_info',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=4, to=orm['common.Contact']),
                      keep_default=False)

        # Adding field 'Sales_Prospect.if_client'
        db.add_column(u'client_sales_prospect', 'if_client',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sales_Prospect.address'
        db.delete_column(u'client_sales_prospect', 'address_id')

        # Deleting field 'Sales_Prospect.contact_info'
        db.delete_column(u'client_sales_prospect', 'contact_info_id')

        # Deleting field 'Sales_Prospect.if_client'
        db.delete_column(u'client_sales_prospect', 'if_client')
