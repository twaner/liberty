...
urlpatterns = patterns('',
    ...
    url(r'^editclient/(?P<client_id>\d+)/$', views.editclient, name='editclient'),
    ...
    url(r'^editsalesprospect/(?P<sales_prospect_id>\d+)/$',
        views.editsalesprospect, name='editsalesprospect'),
)