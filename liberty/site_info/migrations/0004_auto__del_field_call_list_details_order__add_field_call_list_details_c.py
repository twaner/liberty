...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Call_List_Details.order'
        db.delete_column(u'site_info_call_list_details', 'order')

        # Adding field 'Call_List_Details.call_order'
        db.add_column(u'site_info_call_list_details', 'call_order',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Call_List_Details.order'
        db.add_column(u'site_info_call_list_details', 'order',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=30),
                      keep_default=False)

        # Deleting field 'Call_List_Details.call_order'
        db.delete_column(u'site_info_call_list_details', 'call_order')
    ...
    models = {
        ...
        u'site_info.call_list_details': {
            ...
            'call_order': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
