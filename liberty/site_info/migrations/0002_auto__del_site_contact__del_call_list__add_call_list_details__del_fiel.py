...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Site_Information.contact'
        db.delete_column(u'site_info_site_information', 'contact_id')
        ...
        db.add_column(u'site_info_site_information', 'site_client',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=4, to=orm['client.Client']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Site_Information.contact'
        db.add_column(u'site_info_site_information', 'contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['common.Contact']),
                      keep_default=False)

        # Adding field 'Site_Information.client'
        db.add_column(u'site_info_site_information', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['client.Client']),
                      keep_default=False)

        # Adding field 'Site_Information.site_contact'
        db.add_column(u'site_info_site_information', 'site_contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['site_info.Site_Contact']),
                      keep_default=False)
