...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Employee.pay_type'
        db.alter_column(u'employee_employee', 'pay_type', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'Employee.pay_rate'
        db.alter_column(u'employee_employee', 'pay_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Employee.pay_type'
        db.alter_column(u'employee_employee', 'pay_type', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Employee.pay_rate'
        db.alter_column(u'employee_employee', 'pay_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))
