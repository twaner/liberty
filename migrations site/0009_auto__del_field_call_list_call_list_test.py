...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Call_List.call_list_test'
        db.delete_column(u'site_info_call_list', 'call_list_test')
        ...
        # Adding M2M table for field call_list_detail on 'Call_List'
        m2m_table_name = db.shorten_name(u'site_info_call_list_call_list_detail')
    ...
    def backwards(self, orm):
        # Adding field 'Call_List.call_list_test'
        db.add_column(u'site_info_call_list', 'call_list_test',
        ...
        # Removing M2M table for field call_list_detail on 'Call_List'
        db.delete_table(db.shorten_name(u'site_info_call_list_call_list_detail'))
