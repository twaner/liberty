...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field call_list_details on 'Call_List'
        m2m_table_name = db.shorten_name(u'site_info_call_list_call_list_details')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Call_List.last_name'
        raise RuntimeError("Cannot reverse this migration. 'Call_List.last_name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Call_List.last_name'
        db.add_column(u'site_info_call_list', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=30),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Call_List.first_name'
        raise RuntimeError("Cannot reverse this migration. 'Call_List.first_name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Call_List.first_name'
        ...
        # Removing M2M table for field call_list_details on 'Call_List'
        db.delete_table(db.shorten_name(u'site_info_call_list_call_list_details'))
    ...
    models = {
        ...
        u'site_info.call_list': {
            ...
            'call_list_details': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['site_info.Call_List_Details']", 'symmetrical': 'False'}),
