...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Site_Contact.site_contact_call_list'
        db.alter_column(u'site_info_site_contact', 'site_contact_call_list_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['site_info.Call_List'], null=True))

        # Changing field 'Site_Contact.site_contact_info'
        db.alter_column(u'site_info_site_contact', 'site_contact_info_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Contact'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Site_Contact.site_contact_call_list'
        raise RuntimeError("Cannot reverse this migration. 'Site_Contact.site_contact_call_list' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Site_Contact.site_contact_call_list'
        db.alter_column(u'site_info_site_contact', 'site_contact_call_list_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['site_info.Call_List']))

        # User chose to not deal with backwards NULL issues for 'Site_Contact.site_contact_info'
        raise RuntimeError("Cannot reverse this migration. 'Site_Contact.site_contact_info' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Site_Contact.site_contact_info'
        db.alter_column(u'site_info_site_contact', 'site_contact_info_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Contact']))
    ...
    models = {
        ...
        u'site_info.site_contact': {
            ...
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'site_contact_call_list': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['site_info.Call_List']", 'null': 'True', 'blank': 'True'}),
            'site_contact_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site_contact_info': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['common.Contact']", 'null': 'True', 'blank': 'True'})
        },
